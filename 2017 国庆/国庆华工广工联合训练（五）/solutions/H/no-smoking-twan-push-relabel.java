...
class Main extends no_smoking_Twan_push_relabel{}
class no_smoking_Twan_push_relabel {
	static Scanner sc = new Scanner(System.in);
	
	public static void main(String[] args) {
		int runs = sc.nextInt();
		while (runs --> 0) new no_smoking_Twan_push_relabel();
	}
	no_smoking_Twan_push_relabel() {
		read();
		solve();
